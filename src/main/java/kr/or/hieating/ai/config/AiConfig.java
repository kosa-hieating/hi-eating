...
/**
 * Spring AI + 원격 Ollama 연동 설정 클래스.
 * 이메일 "생성용"과 "검증용" 두 개의 ChatClient Bean을 각각 다른 원격 Ollama 서버로 구성
...
public class AiConfig {
  ...
  public ChatClient emailValidationChatClient(AiProperties properties) {
    ...
    /**
     * 공통 ChatClient 생성 로직.
     * baseUrl, model, temperature, timeout 설정값으로 원격 Ollama 서버에 연결되는 ChatClient를 만든다.
     *
