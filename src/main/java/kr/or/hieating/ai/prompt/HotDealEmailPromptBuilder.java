...
public class HotDealEmailPromptBuilder {
  ...
  private static final String INSTRUCTION =
      ...
      - 제목은 80자 이내의 자연스러운 한국어로 작성하세요.
      - 본문에는 상품명, 할인 혜택, 판매 기간을 자연스럽게 포함하세요.
      - 한국어 문장만 사용하세요. 영어, 독일어, 일본어, 중국어 및 외국어 단어를 섞지 마세요.
      - 중괄호와 불필요한 특수문자를 사용하지 마세요.
      - 입력 상품명 앞에 영문 브랜드가 있더라도 영문 브랜드는 본문에 쓰지 마세요.
      - 가격은 천 단위 쉼표와 원 단위를 사용하세요. 예: 33,000원
      - 입력에 없는 효능, 가격, 할인율, 재고, 무료 배송 정보를 만들어내지 마세요.
      - 과장 광고와 지나친 긴급성 표현을 피하세요.
      - 개인정보나 사용자 이름을 포함하지 마세요.
      - 본문은 300자 이상 500자 이하로 간결하게 작성하세요.
      - 인사말, 핵심 혜택, 판매 기간, 마무리를 문단으로 나누고 줄바꿈은 \n으로 표현하세요.
      - HTML 태그와 URL은 작성하지 마세요. 배너와 링크는 서버가 별도로 추가합니다.
