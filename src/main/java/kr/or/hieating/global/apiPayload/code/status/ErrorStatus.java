...
public enum ErrorStatus implements BaseErrorCode {
  ...
  INVALID_PROMOTION_DATE(
      HttpStatus.BAD_REQUEST, "PROMOTION4003", "프로모션 시작일은 종료일보다 이전이거나 같아야 합니다."),
  INVALID_FILE_TYPE(
      HttpStatus.BAD_REQUEST, "PROMOTION4004", "이미지 파일만 업로드할 수 있습니다. (허용 확장자: jpg, jpeg, png, gif, webp)"),
  EMPTY_FILE(
      HttpStatus.BAD_REQUEST, "PROMOTION4005", "업로드할 이미지 파일이 비어 있습니다."),
